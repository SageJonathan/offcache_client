        ...
        <div className="signup__content">
          <div className="signup__header">
            ...
            <p className="signup__subtitle">
              Start your journey toward meaningful connections and authentic
              relationships
            </p>
          </div>
          ...
          <form className="signup__form" onSubmit={handleSubmit}>
            ...
            <div className="signup__form-options">
              ...
              <label className="signup__checkbox-label">
                ...
                />
                <span className="signup__checkbox-text">
                  I'd like to receive updates about community events and new
                  features
                </span>
              </label>
            </div>
        ...
        <div className="signup__image">
          <div className="signup__image-content">
            <h2 className="signup__image-title">
              Forget the Script. Clear the Cache. Connect for Real.
            </h2>

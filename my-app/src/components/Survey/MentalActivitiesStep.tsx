...
import { mentalActivities } from "../../data/static/surveyData";

interface MentalActivitiesStepProps {
  data: any;
  onChange: (field: string, value: any) => void;
}

const MentalActivitiesStep: React.FC<MentalActivitiesStepProps> = ({
  data,
  onChange,
}) => {
  return (
...
export default MentalActivitiesStep;
